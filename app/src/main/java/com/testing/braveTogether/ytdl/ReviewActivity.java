...
public class ReviewActivity extends Activity {
    ...
    private void loadAccount() {
        ...
        mChosenAccountName = sp.getString(RecordActivity.ACCOUNT_KEY, null);
    ...
    public void uploadVideo(View view) {
        ...
        if (mFileUri != null) {
            ...
            uploadIntent.putExtra(RecordActivity.ACCOUNT_KEY, mChosenAccountName);
            startService(uploadIntent);
            Toast.makeText(this, R.string.youtube_upload_started,
                    Toast.LENGTH_LONG).show();
            // Go back to RecordActivity after upload
            finish();
        }
    }
