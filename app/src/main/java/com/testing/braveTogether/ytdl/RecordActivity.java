...
import com.testing.braveTogether.ytdl.util.NetworkSingleton;
import com.testing.braveTogether.ytdl.util.Upload;
import com.testing.braveTogether.ytdl.util.Utils;
import com.testing.braveTogether.ytdl.util.VideoData;
        ...
        new AsyncTask<Void, Void, List<VideoData>>() {
            ...
            protected List<VideoData> doInBackground(Void... voids) {
                ...
                try {
                    ...
                    Utils.logAndShow(RecordActivity.this, Constants.APP_NAME, e);
                }
                return null;
            }
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                Dialog dialog = GooglePlayServicesUtil.getErrorDialog(
                        connectionStatusCode, RecordActivity.this,
